...
Get supported Monolog and help fund the project with the [Tidelift enrollment](https://tidelift.com/enrollment/pkg/packagist-monolog-monolog?utm_source=packagist-monolog-monolog&utm_medium=referral&utm_campaign=enterprise) or via [GitHub sponsorship](https://github.com/sponsors/Seldaek).
